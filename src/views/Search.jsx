...
export default function Search() {
  ...
  useEffect(() => {
    const url = buildURL({ view: 'search', q: debouncedQ.trim() })
    try { history.replaceState({ view: 'search', q: debouncedQ.trim(), id: null, name: null, titleAlt: null, ep: null, lang: 'sub' }, '', url) } catch {}
  }, [debouncedQ])
